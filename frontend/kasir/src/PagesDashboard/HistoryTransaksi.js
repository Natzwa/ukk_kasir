...
export default class HitoryTransaksi extends React.Component {
    ...
    getTypeRoom = () => {
        let url = "http://localhost:8080/meja/get";
        axios
            .get(url, this.headerConfig())
            .then((response) => {
                this.setState({
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-white w-1/3">
                            ...
                            <div class="px-6 py-6 lg:px-8">
                                ...
                                <form class="space-y-6" >
                                    ...
                                    <div>
                                        <label for="id_menu" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">Jumlah : {this.state.detailTransaksi.qty}</label>

                                    </div>
                                    <div>
                                        <label for="id_menu" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">Total : {this.state.detailTransaksi.qty * this.state.detailTransaksi.harga}</label>

                                    </div>
                                    <div>
                                        <label for="id_menu" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">Status : {this.state.detailTransaksi.status}</label>
