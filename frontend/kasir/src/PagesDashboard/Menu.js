...
export default class Menu extends React.Component {
    ...
    handleSave = (e) => {
        ...
        if (this.state.action === "insert") {
            let url = "http://localhost:8080/menu/postmenu"
            ...
            let url = "http://localhost:8080/menu/" + this.state.id_menu
    ...
    handleDrop = (id) => {
        let url = "http://localhost:8080/menu/" + id
    ...
    _handleFilter = () => {
        ...
        let url = "http://localhost:8080/menu/findmenu"
    ...
    getmenu = () => {
        let url = "http://localhost:8080/menu/getmenu";
        axios
                                        ...
                                        <div class="CardEvent" key={index}>
                                            <div class="max-w-sm rounded overflow-hidden shadow-lg border-2 border-gray-200 bg-gray-100">
                                                <div className='container'>
                                                    <img class="w-full h-48" src={"http://localhost:8080/gambar/" + item.gambar} />
                                                    {this.state.role === "admin" &&
                                                        <>
